...
public class TwentySevenModelMapper {
	public static FileAttachment createFileAttachment(JSONObject jsonObject, TwentySevenChanLocator locator,
		...
		attachment.setThumbnailUri(locator, locator.buildPath(boardName, "thumb", tim +
				((".webm".equals(ext) || ".mp4".equals(ext)) ? ".jpg" : ext)));
		attachment.setOriginalName(filename);
		return attachment;
	}

	public static Post createPost(JSONObject jsonObject, TwentySevenChanLocator locator, String boardName)
	...
	public static Posts createThread(JSONObject jsonObject, TwentySevenChanLocator locator, String boardName,
