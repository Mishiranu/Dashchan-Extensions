...
public class HaibaneCatalogParser {
	...
	public HaibaneCatalogParser(String source, Object linked) {
		this.source = source;
	...
	private static final TemplateParser<HaibaneCatalogParser> PARSER = new TemplateParser<HaibaneCatalogParser>()
		...
		if (holder.post != null) {
			...
			HaibanePostsParser.mapFileInfo(attachment, attributes.get("title"));
		...
		if (holder.post != null) {
			...
			if (index >= start && index < end) {
				...
				Matcher matcher = HaibanePostsParser.PATTERN_NUMBER.matcher(source);
