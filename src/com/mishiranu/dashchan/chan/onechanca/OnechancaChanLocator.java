...
public class OnechancaChanLocator extends ChanLocator {
	...
	public String getBoardName(Uri uri) {
		...
		if (matcher.matches()) {
			...
			if ("news/all".equals(boardName)) {
				return "news-all";
			}
			if ("news/hidden".equals(boardName)) {
				return "news-hidden";
			}
			if (boardName.contains("/cat/")) {
				return boardName.replace("/cat/", "-");
			}
			return boardName;
		} else {
	...
	public Uri createBoardUri(String boardName, int pageNumber) {
		...
		if ("news-hidden".equals(boardName)) {
			boardName = "news/hidden";
		} else if (boardName != null) {
			boardName = boardName.replace("-", "/cat/");
		}
	...
	public Uri createThreadUri(String boardName, String threadNumber) {
		if (boardName != null && boardName.startsWith("news-")) {
			boardName = "news";
		}
