...
{
	private static final HttpRequest.RedirectHandler NOT_FOUND_REDIRECT_HANDLER = new HttpRequest.RedirectHandler()
	{
		@Override
		public Action onRedirectReached(int responseCode, Uri requestedUri, Uri redirectedUri, HttpHolder holder)
				throws HttpException
		{
			if (redirectedUri.toString().contains("/arch/")) throw HttpException.createNotFoundException();
	...
	public SendPostResult onSendPost(SendPostData data) throws HttpException, ApiException, InvalidResponseException
	{
		...
		if (data.attachments != null)
		{
			...
			if (data.attachments[0].optionSpoiler) entity.add("spoiler", "1");
		}
