...
public class LolifoxSearchParser {
	private final String source;
	private final LolifoxChanLocator locator;
	...
	public LolifoxSearchParser(String source, Object linked) {
		this.source = source;
		locator = LolifoxChanLocator.get(linked);
	}
	...
	private static final TemplateParser<LolifoxSearchParser> PARSER = TemplateParser.<LolifoxSearchParser>builder()
