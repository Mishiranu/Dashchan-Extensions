...
public class DollchanModelMapper {
	public static FileAttachment createFileAttachment(JSONObject jsonObject, DollchanChanLocator locator)
	...
	public static Post createPost(JSONObject jsonObject, DollchanChanLocator locator, String threadNumber)
	...
	public static Posts createPosts(JSONObject jsonObject, DollchanChanLocator locator) throws JSONException,
			ParseException {
	...
	public static Posts[] createThreads(JSONArray jsonArray, DollchanChanLocator locator) throws JSONException,
			ParseException {
		if (jsonArray != null && jsonArray.length() > 0) {
